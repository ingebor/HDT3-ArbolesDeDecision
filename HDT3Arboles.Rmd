...
### Mixture of gaussians
```{r calGau, echo=FALSE}
silmg<-silhouette(mc$classification,dist(datos[,1:7]))
mean(silmg[,3])
```

Según los valores obtenidos, el que cuenta con la mayor silueta es el cluster jerárquico con un valor de 0.625
